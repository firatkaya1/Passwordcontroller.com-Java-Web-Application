                                    ...
                                    <ul id="navigation">
                                        ...
                                        <li><a class="active" href="#">Manage <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                ...
                                                <li><a href="telephone-table.html">Telephone Directory</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Profile</a>
                                            <ul class="submenu">
        ...
        <div style="max-width: 94%;" class="container">
            <div class="account-content">
                        ...
                        <div class="containerx">
                            ...
                            <div class="subscribe">
                                ...
                                <form action ="socialmediaservices" method = "post">
                                    ...
                                    <input type="text" name="type" placeholder="Social Media" id="type">
                                    <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="Social Media's Address*" id="email">
                ...
                <div class="account-form">
                    <h2 class="form-title">Social Media Table</h2>
                        ...
                        <div class="table-responsive table--no-card m-b-40">
                            <table class="table table-borderless table-striped table-earning" id="table">
                                ...
                                <tr>
                                    <th>Id</th>
                                    <th>Social Media</th>
                                    <th>Social Media's Address</th>
                                    <th>Social Media's Username</th>
                                    <th>Social Media's Password</th>
                                    <th>Explanation</th>
                                    <th>Actions</th>
                                </tr>
                                </thead>
                                <tbody>
	                                <c:forEach items="${socialMediaList}" var="SocialMediaTable">
							            ...
							            <td><c:out value="${SocialMediaTable.socialMediaUsername}"/></td> 	
							           	<td><input type="password" readonly class="password" value="${SocialMediaTable.socialMediaPassword}" style="background: none;"><i class="zmdi zmdi-eye actions-eye show-password" id="${SocialMediaTable.id}"></i></td>
							           	<td><c:out value="${SocialMediaTable.socialMediaExplanation}"/></td>    
							            <td class="text-right actions-td">
	                                        <span title="Edit"><i class="zmdi zmdi-edit actions-edit" id="${SocialMediaTable.id}"></i></span>
...
<script src="js/socialtable.js"></script>
